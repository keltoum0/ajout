...
<form name="form1" method="post" onSubmit="return check();">
  <table class="table table-striped">
    <tr>
      <td width="49%" height="32"><div align="left"><strong>Choisir Module </strong></div></td>
      <td width="3%" height="5">
...
?>
    ...
    <tr>
        <td height="26"><div align="left"><strong> Nom Test </strong></div></td>
        <td>&nbsp;</td>
	  <td><input class="form-control" name="testname" type="text" id="testname"></td>
    </tr>
    <tr>
      <td height="26"><div align="left"><strong>Nombre de questions </strong></div></td>
      <td>&nbsp;</td>
